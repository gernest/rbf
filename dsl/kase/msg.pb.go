...
type Map struct {
	...
	Blob map[string]string `protobuf:"bytes,1,rep,name=blob,proto3" json:"blob,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
...
func (x *Map) GetBlob() map[string]string {
	if x != nil {
		return x.Blob
	}
	return nil
...
var file_msg_proto_rawDesc = []byte{
	...
	0x28, 0x0c, 0x52, 0x04, 0x62, 0x6c, 0x6f, 0x62, 0x22, 0x67, 0x0a, 0x03, 0x4d, 0x61, 0x70, 0x12,
	0x27, 0x0a, 0x04, 0x62, 0x6c, 0x6f, 0x62, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x13, 0x2e,
	0x6b, 0x61, 0x73, 0x65, 0x2e, 0x4d, 0x61, 0x70, 0x2e, 0x42, 0x6c, 0x6f, 0x62, 0x45, 0x6e, 0x74,
	0x72, 0x79, 0x52, 0x04, 0x62, 0x6c, 0x6f, 0x62, 0x1a, 0x37, 0x0a, 0x09, 0x42, 0x6c, 0x6f, 0x62,
	...
	0x67, 0x65, 0x72, 0x6e, 0x65, 0x73, 0x74, 0x2f, 0x72, 0x62, 0x66, 0x2f, 0x64, 0x73, 0x6c, 0x2f,
	0x6b, 0x61, 0x73, 0x65, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}
...
var file_msg_proto_goTypes = []interface{}{
	...
	(*Map)(nil),     // 6: kase.Map
	nil,             // 7: kase.Map.BlobEntry
}
var file_msg_proto_depIdxs = []int32{
	0, // 0: kase.Mutex.mutex:type_name -> kase.Mutex.Enum
	7, // 1: kase.Map.blob:type_name -> kase.Map.BlobEntry
